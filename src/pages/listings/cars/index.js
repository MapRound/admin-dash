              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value='admin'>Lagos</MenuItem>
                    <MenuItem value='chef'>Abuja</MenuItem>
                    <MenuItem value='driver'>Port Harcourt</MenuItem>
              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value='company'>Premium</MenuItem>
                    <MenuItem value='enterprise'>Vip</MenuItem>
                    <MenuItem value='team'>Platinum</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item sm={4} xs={12}>
